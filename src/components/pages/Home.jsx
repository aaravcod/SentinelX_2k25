      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-10 left-10">
            <FaLeaf className="w-32 h-32 text-primary-600 transform rotate-12" />
          </div>
          <div className="absolute top-40 right-20">
            <FaTree className="w-24 h-24 text-primary-600 transform -rotate-12" />
          </div>
          <div className="absolute bottom-20 left-1/4">
            <FaLeaf className="w-20 h-20 text-primary-600 transform rotate-45" />
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <h2 className="text-2xl lg:text-4xl font-bold text-secondary-900 ">
                  Empowering
                  <span className="text-primary-600 block">Forest Rights</span>
                  through Data
                </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="bg-primary-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-primary-700 transition-all duration-300 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
                ...
                <button
                  ...
                  className="border-2 border-secondary-300 text-secondary-700 px-8 py-4 rounded-xl font-semibold hover:border-primary-500 hover:text-primary-700 transition-all duration-300 flex items-center justify-center gap-3"
                >
              ...
              {/* Trust Indicators */}
              <div className="flex items-center gap-6 pt-8 border-t border-secondary-200">
                <div className="flex items-center gap-2">
                  <FiShield className="w-5 h-5 text-primary-600" />
                  <span className="text-sm text-secondary-600">Government Certified</span>
                </div>
                <div className="flex items-center gap-2">
                  <FiCheckCircle className="w-5 h-5 text-primary-600" />
                  <span className="text-sm text-secondary-600">ISO 27001 Compliant</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
                ...
                <div className="bg-primary-50 rounded-lg p-4 mb-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="h-16 bg-gradient-to-br from-primary-400 to-primary-600 rounded-lg flex items-center justify-center">
                        <MdDashboard className="w-6 h-6 text-white" />
                      </div>
                      <div className="h-16 bg-gradient-to-br from-accent-400 to-accent-600 rounded-lg flex items-center justify-center">
              ...
              {/* Floating Elements */}
              <div className="absolute -top-4 -right-4 bg-primary-500 text-white p-3 rounded-xl shadow-lg transform rotate-12">
                <MdAnalytics className="w-6 h-6" />
              </div>
              <div className="absolute -bottom-4 -left-4 bg-accent-500 text-white p-3 rounded-xl shadow-lg transform -rotate-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  <div className={`w-14 h-14 rounded-xl flex items-center justify-center mb-6 ${feature.color === 'primary' ? 'bg-primary-100' :
                      feature.color === 'accent' ? 'bg-accent-100' :
                        feature.color === 'error' ? 'bg-error-100' :
                          'bg-secondary-100'
                    }`}>
                    <IconComponent className={`w-7 h-7 ${feature.color === 'primary' ? 'text-primary-600' :
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <h2 className="text-3xl lg:text-5xl font-bold text-secondary-900">
                  Transform Your
                  <span className="text-primary-600 block">Operations</span>
                </h2>
              ...
              <button
                ...
                className="bg-primary-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-primary-700 transition-all duration-300 flex items-center gap-3"
              >
                Explore Features
                <FiArrowRight className="w-5 h-5" />
              </button>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  ...
                  <div className="bg-gradient-to-br from-accent-500 to-accent-700 rounded-2xl p-6 text-white">
                    ...
                    <div className="text-accent-100">Efficiency Gain</div>
                  </div>
                </div>
                <div className="space-y-4 pt-8">
                  <div className="bg-gradient-to-br from-accent-500 to-accent-700 rounded-2xl p-6 text-white">
                    ...
                    <div className="text-accent-100">Monitoring</div>
                  </div>
                  <div className="bg-gradient-to-br from-accent-500 to-accent-700 rounded-2xl p-6 text-white">
                    <FiTrendingUp className="w-8 h-8 mb-4" />
                    <div className="text-2xl font-bold">150%</div>
                    <div className="text-accent-100">ROI Increase</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-secondary-50">
        <div className="max-w-2xl mx-auto px-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            {/* Success Message */}
            {submitted && (
              <div className="mb-6 p-4 bg-primary-50 border border-primary-200 text-primary-700 rounded-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full bg-primary-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary-700 transition-colors duration-300 flex items-center justify-center gap-2"
                >
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="bg-white text-primary-600 px-8 py-4 rounded-xl font-semibold hover:bg-secondary-50 transition-all duration-300 flex items-center justify-center gap-3 shadow-lg"
              >
                Start Exploring
                <FiArrowRight className="w-5 h-5" />
              </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold text-white">SentinelX</h3>
              </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-primary-400">support@fradrishti.gov.in</p>
              </div>
            </div>
          </div>

          <div className="border-t border-secondary-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-secondary-400">© 2025 SentinelX. All rights reserved.</p>
