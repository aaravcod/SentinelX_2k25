      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 to-primary-800 p-12 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <p className="text-primary-100 mb-6 text-lg max-w-xl">
            Secure access to empowered data for forest rights implementation and governance.
          </p>
          {/* Compliance & Security */}
          ...
          <div className="mb-8">
            <h3 className="font-semibold mb-2 text-lg">For Departments</h3>
          ...
          <div className="mt-auto">
            <div className="bg-accent-500 bg-opacity-20 rounded-lg p-4 flex items-center gap-3">
              <FiArrowRight className="w-6 h-6 flex-shrink-0" />
              <span className="text-lg font-medium">
                Empowering transparent and accountable data-driven administration
              </span>
            </div>
          </div>
        </div>
